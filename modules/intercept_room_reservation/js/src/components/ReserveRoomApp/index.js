...
const ReserveRoomApp = props => <ReserveRoom {...props} />;

ReserveRoomApp.propTypes = {
...
export default updateWithHistory(addUrlProps({ urlPropsQueryConfig })(ReserveRoomApp));
